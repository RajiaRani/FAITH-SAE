"""_common.py — shared setup every step script in milestone 6 imports.
...
The project root (three levels up from this file:
  .../25_Rajia_Rani_FAITH_SAE/code/milestone_6_headline_experiment/_common.py
   parents[0] = milestone_6_headline_experiment
   parents[1] = code
...
HERE = pathlib.Path(__file__).resolve().parent       # milestone_6_headline_experiment/
