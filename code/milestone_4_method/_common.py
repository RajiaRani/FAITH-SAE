"""_common.py — shared setup every step script in milestone 4 imports.

WHY THIS FILE EXISTS
--------------------
Each step script (step1_*.py ... step5_*.py) needs to do the SAME boring things
...
The project root (three levels up from this file:
  .../25_Rajia_Rani_FAITH_SAE/code/milestone_4_method/_common.py
   parents[0] = milestone_4_method
   parents[1] = code
...
HERE = pathlib.Path(__file__).resolve().parent       # milestone_4_method/
